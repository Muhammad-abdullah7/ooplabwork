        ...
        static void searchbyisbn()
        {
            ...
            foreach (Product book in products)
            {
                if (book.ISBN == isbn)
                {
                    ...
                    Console.WriteLine($"The name of the publisher is as follows:{book.Publisher}");
                    Console.WriteLine($"The ISBN of the book is {book.Title} is {isbn}");
                    Console.WriteLine($"The number of copies of the respective book is:{book.Copies}");
                }
            }
        }
        static void update()
        {
            Console.WriteLine("Enter the title of the book(for updation: ");
            string title = Console.ReadLine() ;
            Console.WriteLine("Enter the new name for the book.");
            string name = Console.ReadLine() ;
            Console.WriteLine("Enter th isbn : ");
            int isbn = int.Parse(Console.ReadLine());
